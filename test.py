...
x_test = np.load('./data/Labelled_data/x_test.npy')
y_test = np.load('./data/Labelled_data/y_test.npy')
pair1_test = np.load('./data/unlabelled_data/pair1_test.npy')
pair2_test = np.load('./data/unlabelled_data/pair2_test.npy')
...
# path_weights = "./weights_mt_au_mae.h5"  # choose weights to test
